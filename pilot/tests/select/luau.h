...
class Luau
{
	...
	public:
		...
		static void doCreate(const char *fromId, const char *trait, const char *toId, int degrees, int zorder, int x, int y);
		static void undo();
		static void redo();
		static void copyCounter(const char *fromId, const char *toId, int degrees, int zorder, int x, int y);
