...
void Overlay::StackOpen::open(Counter *counter, QPoint pos)
{
	...
	Overlay::openView->updateImages(counter);
	Overlay::openView->showStack();
	Overlay::openView->resize(Overlay::openView->layout->layoutWidth + 4, 
							  Overlay::openView->layout->layoutHeight + 4);	
	Overlay::openView->moveThis(pos, Overlay::openView->layout->layoutWidth + 4, 
									 Overlay::openView->layout->layoutHeight + 4);
