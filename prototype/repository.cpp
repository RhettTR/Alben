...
std::stack<std::any> Repository::panes;


QList<Repository::Pane*> Repository::paneList;
...
Repository::Pane::Pane(QWidget *parent) : QLabel(parent)
{
...
void Repository::Pane::resizeEvent(QResizeEvent* event)
{
...
Repository::ListBox::ListBox(QWidget *parent) : QListWidget(parent)
{
...
void Repository::ListBox::itemClicked(ListItem *item)
{	
...
void Repository::ListBox::itemSelectionChanged()
{	
...
Repository::ListItem::ListItem(const QString &text, ListBox *parent, Pane *paneParent, int type) : 
...
Repository::ComboBox::ComboBox(QWidget *parent) : QComboBox(parent)
{
	QObject::connect(this, &QComboBox::activated, 
					 this, [=]()->void{ activated(this->currentIndex()); });
}

void Repository::ComboBox::activated(int index)
{	
...
Repository::Repository(QWidget *parent) : QMainWindow(parent, Qt::Window | Qt::WindowMinimizeButtonHint)
{	
...
void Repository::resizeEvent(QResizeEvent* event)
{
...
Repository::Pane* Repository::getParent()
{
...
void Repository::root(int level)
{	
...
void Repository::tabs(int level)
{
...
void Repository::tab(int level, std::string text)
{
...
void Repository::listBox(int level)
{
...
void Repository::listItem(int level, std::string text)
{
...
void Repository::comboBox(int level)
{
...
void Repository::comboItem(int level, std::string text)
{
